...
export function TabsDemo() {
  const tabs = [
    ...
    },
    {
      ...
      value: "services",
      content: (
        <div className="w-full overflow-hidden relative h-full rounded-2xl p-10 text-xl md:text-4xl font-bold text-white bg-gradient-to-br from-[#C9A94B] to-[#7D6620]">
          <p>Services tab</p>
          <DummyContent />
        </div>
      ),
    ...
    },
    {
      ...
      value: "random",
      content: (
        <div className="w-full overflow-hidden relative h-full rounded-2xl p-10 text-xl md:text-4xl font-bold text-white bg-gradient-to-br from-emerald-700 to-teal-900">
          <p>Random tab</p>
          <DummyContent />
        </div>
      ),
...
const DummyContent = () => {
  return (
    <img
      ...
      width="1000"
      height="1000"
      className="object-contain object-left-top h-[60%] md:h-[90%] absolute -bottom-10 inset-x-0 w-[90%] rounded-xl mx-auto opacity-50 mix-blend-overlay"
    />
  );
};
