...
const ShapeGrid: React.FC<ShapeGridProps> = ({
  ...
  useEffect(() => {
    ...
    const drawGrid = () => {
      ...
      // Removing the gradient overlay since it makes it dark in the center and we just want the shapes as background
      // If we want a fade out at edges, we can apply it via CSS or keep the code but adjusted.
      // I will keep the original gradient if desired, but since it's a dark background we want the grid everywhere.
    };
