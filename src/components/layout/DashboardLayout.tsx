    ...
    <div className="flex h-screen bg-black overflow-hidden relative">
      ...
      <div className="flex z-10 w-full h-full">
        ...
        <main className="flex-1 min-h-0 flex flex-col overflow-y-auto custom-scrollbar relative pb-[calc(6rem+env(safe-area-inset-bottom,0px))] md:pb-0">
          <React.Suspense fallback={<div className="flex-1 flex items-center justify-center"><div className="w-8 h-8 border-4 border-[#C9A94B]/30 border-t-[#C9A94B] rounded-full animate-spin"></div></div>}>
            <Outlet />
          </React.Suspense>
        </main>
      </div>
